    		...
    		<div class="pricing-model-wrap">
	    		<div class="price-model">
	    			...
	    			<div class="price-model-inner">
		    			<div class="price-tag">
		    				<p><span class="euros">3<sup class="cents">99</sup></span><sub>€</sub>
		    				<span class="note-text"> / per user a month</span></p>
		    			</div>
	    		...
	    		<div class="price-model">
	    			...
	    			<div class="price-model-inner">
		    			<div class="price-tag">
		    				<p><span class="euros">5<sup class="cents">99</sup></span><sub>€</sub>
		    				<span class="note-text"> / per user a month</span></p>
		    			</div>
